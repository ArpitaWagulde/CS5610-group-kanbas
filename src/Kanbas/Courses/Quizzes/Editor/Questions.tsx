...
function QuestionsEditor(){
    ...
    return(
        <>
        <button className="btn btn-light m-1 border border-light-grey rounded border-1">+ New Question</button>
        <button className="btn btn-light m-1 border border-light-grey rounded border-1">+ New Question Group</button>
        <button className="btn btn-light m-1 border border-light-grey rounded border-1">&#128269; Find Question</button>
