...
import { FaCheckCircle, FaEllipsisV, FaEdit, FaBan, FaInfoCircle } from "react-icons/fa";
...
function Preview() {
    ...
    useEffect(() => {
      ...
      return(
        ...
        <div className="info-symbol"><FaInfoCircle/></div>
        <div className="info-text">This is a preview of the published version of the quiz</div>
        </div>
